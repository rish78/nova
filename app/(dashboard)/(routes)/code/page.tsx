...
const CodePage = ()=> {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try{
            ...
            console.log(text);
            setMessages((current) => [...current, {role: "user", content: values.prompt}, {role:"model", content: text}]);
            form.reset();
        }catch(error:any){
  ...
  return (
    <div>
      <Heading
        ...
        description="Generate efficient code using AI."
        icon={Code}
                  ...
                  <FormItem className="col-span-12 lg:col-span-10">
                    <FormControl className="m-0 p-0">
                      <Input
                        ...
                        disabled={isLoading} 
                        placeholder="Generate code to create a react form." 
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
